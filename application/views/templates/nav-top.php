	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span>Travel</span>Order</a>
				<ul class="user-menu">
					<li class="dropdown pull-right">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a href="<?php echo base_url(); ?>index.php/travel_orders/logout"><svg class="glyph stroked cancel"><use xlink:href="#"></use></svg> Logout</a></li>
						</ul>
					</li>
				</ul>
			</div>
